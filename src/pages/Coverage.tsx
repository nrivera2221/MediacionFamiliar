...
const Coverage = () => {
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="bg-mediacion-blue text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">
            Nuestros servicios de mediación familiar están disponibles en toda
            la provincia de Atacama, tanto de forma presencial como online.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Ofrecemos servicios de mediación familiar en toda la provincia
                de Atacama, con atención presencial en Copiapó y disponibilidad
                para desplazarnos a otras localidades según las necesidades de
                nuestros clientes.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                Además, a través de nuestra modalidad de mediación online,
                podemos atender a personas que se encuentren en cualquier parte
                de la región, sin necesidad de desplazamientos.
              </p>

              <div className="bg-mediacion-beige p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-mediacion-blue mb-4">
                  Cobertura de mediación presencial y online:
                </h3>
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Atención online y presencial programada
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Nuestra plataforma de mediación online elimina las barreras
              geográficas, permitiéndote acceder a servicios profesionales de
              mediación familiar desde cualquier lugar.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="w-16 h-16 rounded-full bg-mediacion-blue/10 flex items-center justify-center mx-auto mb-4">
                <svg
                  className="w-8 h-8 text-mediacion-blue"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              <h3 className="text-xl font-semibold text-mediacion-blue mb-2">
                Cobertura total
              </h3>
              <p className="text-gray-700">
                Nuestros servicios online llegan a todos los rincones de la
                región de Atacama, sin importar qué tan alejada sea tu
                ubicación.
              </p>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-mediacion-blue mb-8 text-center">
            Locaciones Presenciales
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-mediacion-beige/50 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-mediacion-blue mb-4">
                Atención programada en otras localidades
              </h3>
              <p className="mb-4">
                Para tu comodidad, ofrecemos servicios de mediación presencial
                programada en otras localidades de la provincia. Contáctanos
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-start">
                  ...
                  <div>
                    <p className="font-semibold">El Salvador</p>
                    <p className="text-sm text-gray-600">
                      Visitas programadas dos veces al mes
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    <p className="font-semibold">Diego de Almagro</p>
                    <p className="text-sm text-gray-600">
                      Visitas programadas previa coordinación
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
              ...
              <p className="bg-mediacion-blue/10 p-4 rounded-lg text-mediacion-blue font-medium">
                Recuerda que también puedes optar por nuestros servicios de
                mediación online, disponibles para todas las localidades sin
