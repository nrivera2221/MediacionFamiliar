      ...
      <section className="bg-mediacion-blue text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">
            Estamos aquí para ayudarte. Completa el formulario o utiliza nuestros canales de contacto directo.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl font-bold text-mediacion-blue mb-6">Información de Contacto</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">+56 9 0000 0000</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">contacto@mediacionatacama.cl</p>
                    <p className="text-sm text-gray-500 mt-1">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Calle Principal 123, Copiapó</p>
                    <p className="text-sm text-gray-500 mt-1">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Lunes a Viernes: 9:00 - 18:00 hrs</p>
                    <p className="text-sm text-gray-500 mt-1">
            ...
            <div>
              <h2 className="text-2xl font-bold text-mediacion-blue mb-6">Envíanos un mensaje</h2>
      ...
      <section className="py-16 bg-mediacion-beige/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-mediacion-blue mb-4">Nuestra Ubicación</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Nos encontramos en una ubicación central y de fácil acceso en Copiapó.
            </p>
          </div>
          ...
          <div className="rounded-lg overflow-hidden shadow-xl h-[400px]">
            <iframe 
              ...
              allowFullScreen 
              loading="lazy"
              title="Ubicación de Mediación Atacama"
              aria-label="Mapa de ubicación de Mediación Atacama"
            ></iframe>
          </div>
        </div>
      </section>
